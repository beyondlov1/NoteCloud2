...
public class MarkDownUtils {
    ...
    public static String convertMarkDownToHtml(String markdown) {
        ...
        return addGithubMarkDownCss(html);
    }

    private static String replaceUrlsToMarkDownStyle(String source) {
    ...
    private static String addGithubMarkDownCss(String content) {
