...
public class OAuth2AccessTokenJsonExtractor20 implements TokenExtractor<OAuth2AccessToken> {
    private static final Pattern ACCESS_TOKEN_REGEX_PATTERN = Pattern.compile("\"id_token\"\\s*:\\s*\"(\\S*?)\"");
    ...
    protected OAuth2AccessTokenJsonExtractor20() {
    }

    private static class InstanceHolder {

        private static final OAuth2AccessTokenJsonExtractor20 INSTANCE = new OAuth2AccessTokenJsonExtractor20();
    }

    public static OAuth2AccessTokenJsonExtractor20 instance() {
        return OAuth2AccessTokenJsonExtractor20.InstanceHolder.INSTANCE;
    }
